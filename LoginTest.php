...
<a href="http://mi-linux.wlv.ac.uk/~1629650/GP/webactivity/LoginWebActivity.php"><button class="button"> WebBuildActivity</button></a>
<button class="button"> Arduino Board</button> 
<button class="button"> Database Security</button>
<button class="button"> Encrypting</button> 
</div>
...
x = document.getElementById("pswd").value;
		...
		if (x =="wolf" || x =="WOLF" || x =="Wolf"){
			...
			text = "Use collected letters in order Activity 1,2.Capital or small ";
		}
